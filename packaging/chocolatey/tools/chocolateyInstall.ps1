...
$pkgUrl = "https://github.com/collabskus/TRGamer-tech-FluentTaskScheduler/releases/download/V$version/Setup-x64.msi"
$pkgHash = 'AFAD2A1E61E4B3F87C1EE2B7ED4E55CFAC9B13DBC5AF7CA99745DA4977539362'

if ($isArm64) {
    $pkgUrl = "https://github.com/collabskus/TRGamer-tech-FluentTaskScheduler/releases/download/V$version/Setup-arm64.msi"
